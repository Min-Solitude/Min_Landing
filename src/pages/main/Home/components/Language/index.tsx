...
const dataLanguage = [
  ...
  {
    id: 4,
    image: 'https://stackdiary.com/wp-content/uploads/2022/10/Tailwind-CSS-15-Component-Libraries-UI-Kits.png',
    title: 'Tailwind CSS',
    description: 'một khung CSS mã nguồn mở. Tính năng chính của thư viện này là, không giống như các khung CSS'
  }
]
